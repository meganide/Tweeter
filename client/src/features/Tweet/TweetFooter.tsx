...
import { httpAddPost } from '../../hooks/requests';
...
function TweetFooter(props: IProps) {
  ...
  const { inputFileRef, chooseImage, submitUpload, handleFileInputChange } =
    upload;

  const [error, setError] = useState('');

  const mutation = useCustomMutation(httpAddPost, 'followersPosts');
