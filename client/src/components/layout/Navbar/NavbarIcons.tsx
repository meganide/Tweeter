...
function NavbarIcons() {
  ...
  return (
    <section className="relative mx-2 flex place-items-center">
      <Search />
      <img className="mr-5 h-[40px] cursor-pointer" src={darkToggle ? imagePaths.darkMode : imagePaths.lightMode} alt="theme" onClick={toggleTheme} />
